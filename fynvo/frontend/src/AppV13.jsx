...
import MobileOverviewV1181 from './MobileOverviewV1181.jsx';
...
const PRODUCTION_VERSION = '1.18.2';
...
export default function AppV13() {
  ...
  return <>
    ...
    <App authState={auth}/>
    <MobileOverviewV1181 authenticated={auth.authenticated} productionVersion={PRODUCTION_VERSION}/>
